 ...
 */
final class Version20181213093441 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, user_order_id INT NOT NULL, commande_date DATETIME NOT NULL, quantity INT NOT NULL, INDEX IDX_6EEAA67D6D128938 (user_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D6D128938 FOREIGN KEY (user_order_id) REFERENCES user (id)');
